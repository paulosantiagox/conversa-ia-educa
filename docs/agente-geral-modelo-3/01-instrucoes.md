...
<!-- 🕒 Última atualização: 2026-08-06 16:41:16 (horário de Brasília) -->
...
- **Tempo de conclusão:** no ritmo do aluno, **sem limite** (estuda quando e onde quiser). Em média, os alunos concluem todas as etapas em até 90 dias.
...
- **"Quanto tempo dura? / Qual o tempo de conclusão?"** → (pode enviar em 2 mensagens)
  "O tempo depende do seu ritmo, você estuda quando e onde quiser, não temos limite. Em média, os alunos do EJA Educa Brasil concluem todas as etapas em até 90 dias."
